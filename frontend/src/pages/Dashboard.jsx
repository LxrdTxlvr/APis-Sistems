...
function Dashboard() {
  ...
  return (
    <div className="glass-panel" style={{ borderTop: '4px solid var(--accent-primary)' }}>
      <h1>Panel General</h1>
      <p>Bienvenido al Centro de Control de APIs. Todo el ecosistema está monitoreado desde aquí.</p>
      ...
      <div className="grid-cards" style={{ marginTop: '32px' }}>
        ...
        <div className="glass-panel" style={{ background: 'rgba(99, 102, 241, 0.05)' }}>
          ...
          <p style={{ marginTop: '10px', fontSize: '0.9rem' }}>Servidor Alojado en RENDER</p>
        </div>

        {/* Ecosistema */}
        <div className="glass-panel">
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <h3>Métricas Locales</h3>
